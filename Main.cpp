			...
			while (SDL_PollEvent(&e) != 0)
			{
				...
				else if (e.type == SDL_KEYDOWN)
				{
					...
					case SDLK_RIGHT:
						...
						break;
					case SDLK_m:
						gCurrentSurface = gKeyPressSurfaces[KEY_PRESS_SURFACE_M];
						break;
					default:
						gCurrentSurface = gKeyPressSurfaces[KEY_PRESS_SURFACE_DEFAULT];
						break;
...
bool loadMedia()
{
	...
	//Load m surface
	gKeyPressSurfaces[KEY_PRESS_SURFACE_M] = loadSurface("resources/stretch.bmp");
	if (gKeyPressSurfaces[KEY_PRESS_SURFACE_M] == NULL)
	{
		printf("Failed to load right image!\n");
		success = false;
	}
